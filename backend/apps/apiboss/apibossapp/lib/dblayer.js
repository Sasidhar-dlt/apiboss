/**
 * Database layer for the Monastery app.
...
const DB_PATH = path.resolve(`${APIBOSS_CONSTANTS.DB_DIR}/apiboss.db`);
const DB_CREATION_SQLS = require(`${APIBOSS_CONSTANTS.DB_DIR}/apibossapp_dbschema.json`);
